          ...
          >
            ...
            >
              ...
              <!-- <div
                ...
                class="w-1/2 md:mb-2"
                v-if="averageValues.averageWordCount.value"
              >
                <div
                ...
                >
                  ...
                  >
                    <component
                      :is="averageValues.averageWordCount.icon"
                      class="hidden w-8 h-8 mx-auto lg:block"
                    />
                  </div>
              ...
              <div
                ...
                class="w-1/2 md:mb-2"
                v-if="averageValues.averageHeaderCount"
              >
                <div
                  class="flex items-center p-0 mb-2 bg-white border rounded-lg md:mb-0"
                >
                  ...
                  <div class="ml-6 leading-6 text-gray-700">
                    <p class="text-2xl font-semibold">
                      {{ averageValues.averageHeaderCount }}
                    </p>
              ...
              <div
                ...
                class="w-1/2 md:mb-2"
                v-if="averageValues.averageImageCount"
              >
                <div
                  class="flex items-center p-0 mb-2 bg-white border rounded-lg md:mb-0"
                >
                  ...
                  <div class="ml-6 leading-6 text-gray-700">
                    <p class="text-2xl font-semibold">
                      {{ averageValues.averageImageCount }}
                    </p>
              ...
              <div
                ...
                class="w-1/2"
                v-if="averageValues.averageParagraphCount"
              >
                <div
                  class="flex items-center p-0 mb-2 bg-white border rounded-lg md:mb-0"
                >
                  ...
                  <div class="ml-6 leading-6 text-gray-700">
                    <p class="text-2xl font-semibold">
                      {{ averageValues.averageParagraphCount }}
                    </p>
